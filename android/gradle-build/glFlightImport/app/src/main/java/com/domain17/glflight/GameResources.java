...
public class GameResources {
    ...
    public static int version = /* TODO: use android-version-string */ 1011800;
    ...
    public static int init(Context c) {
        ...
        try {
            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(envPrefix + "/" + resFilename)));
            String previousVersion = br.readLine();
            String compareString = String.valueOf(version);
            if (previousVersion.toString().compareTo(compareString) != 0) {
                reload = true;
            }
        }
        catch (Exception e) {
        ...
        // write out version
        try {
            byte[] versionBuf = Integer.toString(version).getBytes();
            (new FileOutputStream(envPrefix + "/" + resFilename)).write(versionBuf);
        }
        catch (Exception e) {
            reload = true;
        }
