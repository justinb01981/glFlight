...
const static quaternion_t QX = {1, 1, 0, 0};
const static quaternion_t QY = {1, 0, 1, 0};
const static quaternion_t QZ = {1, 0, 0, 1};
...
void quaternion_rotate_inplace(quaternion_t* v, const quaternion_t* u, float r);
...
// euler values for heading vector
void
