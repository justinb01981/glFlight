    ...
    if(time_ms - game_run_last >= 100)
    {
        ...
        while(pCur)
        {
            ...
            {                    
                ...
                case OBJ_BASE:
                    pCur->elem->renderInfo.tex_phase++;
                    pCur->elem->texture_id = texture_sequence_obj_base[pCur->elem->renderInfo.tex_phase % (sizeof(texture_sequence_obj_base)/sizeof(int))];
